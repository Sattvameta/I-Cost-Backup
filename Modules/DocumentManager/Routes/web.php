...
*/
	...
	Route::post('fileUpload/documentmanager','DocumentManagerController@fileUpload')->name('documentmanager.fileUpload');
	Route::get('/create/{rowcount}', 'DocumentManagerController@create')->name('documentmanager.create');
