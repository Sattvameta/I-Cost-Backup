           ...
           $query = Purchase::select(['id', 'project_id', 'supplier_id', 'revision_no', 'purchase_no', 'grand_total', 'delivery_date', 'created_at']);
            ...
            return datatables()->of($query)
                   ...
                   ->addColumn('delivery', function ($purchase) {
					 ...
					 return '<a href= "../public/uploads/purchase_deliverynote/'.$inv->delivery_note.'" class=\"btn btn-success btn-sm\">View</a>';
					...
					->addColumn('cer', function ($purchase) {
					 ...
					 return '<a href= "../public/uploads/purchase_certificate/'.$inv->certificate.'" class=\"btn btn-success btn-sm\">View</a>';
                    ...
                    ->rawColumns(['revision_no', 'grand_total', 'action','delivery','cer'])
                    ->make(true);
        }
    }
          ...
          $query =DB::table('v_purchase_delivery_certificate_supplier')->select(['id', 'project_id', 'supplier_id', 'revision_no', 'purchase_no', 'grand_total', 'delivery_date', 'created_at','supplier_name','unique_reference_no','company_id']);
            ...
            return datatables()->of($query)
					 ...
					 ->editColumn('invoice_file', function ($purchase) {
                        $invoices_po = DB::table('purchase_invoices')->select('invoice_file')->where('purchase_id',$purchase->id)->orderBy('id')->get();
						 $file="";
                           foreach($invoices_po as $inv){
                       if($inv->invoice_file !=""){
					  $file.='<a href= "../public/uploads/purchase_invoice_file/'.$inv->invoice_file.'" class=\"btn btn-success btn-sm\">View</a>'."\n\r"." &nbsp&nbsp ";
					   }else{
                   ...
                   ->addColumn('delivery', function ($purchase) {
					  ...
					  $delivery.='<a href= "uploads/purchase_deliverynote/'.$inv->delivery_note.'" class=\"btn btn-success btn-sm\">View</a>'."\n\r"." &nbsp,&nbsp ";
					...
					->addColumn('cer', function ($purchase) {
					  ...
					  $cer.='<a href= "../public/uploads/purchase_certificate/'.$inv->certificate.'" class=\"btn btn-success btn-sm\">View</a>'."\n\r"." &nbsp,&nbsp ";
					  ...
					  $photo.='<a href= "../storage/app/public/purchases/'.$inv->photo.'" class=\"btn btn-success btn-sm\">View</a>'."\n\r"." &nbsp,&nbsp ";
