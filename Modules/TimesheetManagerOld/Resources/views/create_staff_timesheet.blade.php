...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="card-title">Daily Activity</h3><hr>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function prepareTimesheetForm(subActivityId){
            var route = "{{ route('timesheets.ajax.staff.timesheet.form') }}";
