        ...
        <tr class="table-success">
            ...
            <tr>
			 <td>Home<br>Office<br>Hybrid</td> 
			  <td><input type="checkbox"><br><input type="checkbox"><br><input type="checkbox"></td>
              <td>walking<br>cycling <br>public transport<br>car<br>Hybrid</td> 
              <td><input type="checkbox"><br><input type="checkbox"><br><input type="checkbox"><br><input type="checkbox"><br><input type="checkbox"></td>
			  <td><input type="number"><br><input type="number"><br><input type="number"><br><input type="number"><br><input type="number"></td>
            </tr>
</table>
<div class="form-group">
        ...
        <tr class="table-success">
            ...
            <tr>
			 <td>Electricity<br>Gas</td> 
			  <td><input type="number"><br><input type="number"></td>
            </tr>
</table>
    ...
    <thead>
        <tr class="table-success">
            ...
            <tr>
              ...
              <td><input type="checkbox"><br><input type="checkbox"><br><input type="checkbox"></td>
			  <td><input type="number"><br><input type="number"><br><input type="number"></td>
            </tr>
</table>
@endif
