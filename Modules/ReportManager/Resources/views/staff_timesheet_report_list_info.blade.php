<div class="card-header">
    ...
    <div class="card-body">                              
            ...
            <i class="pe-7s-print btn-icon-wrapper"></i>Print
              ...
              <button onclick="window.location.href='{{ route('reports.export.staff.timesheet.report', $project->id) }}'"  type="button" class="mb-2 mr-2 btn-icon-vertical btn btn-info">
                                                ...
                                                @if($bDetailTimesheets->isNotEmpty())
                                                    @foreach($bDetailTimesheets as $bDetailTimesheet)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>                          
                                                                {{ date("d/m/Y", strtotime($bDetailTimesheet->timesheet_date)) }}
                                                            </td>
                                                            <td>                          
