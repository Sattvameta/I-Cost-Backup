                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="role_id" class="form-control roles-permissio multiselect-dropdown">
                                                ...
                                                <option value="{{$role->id}}" {{($role->name=='admin')?'selected':''}}>{{ucwords($role->name)}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="permissions-listing">
                                            <table class="table table-hover text-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="col-md-6 permissions-col">{{ucwords(str_replace('purchaseorders','Purchase Orders',$key)) }}</td>
