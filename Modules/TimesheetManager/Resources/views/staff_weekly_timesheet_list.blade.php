        ...
        @if($timesheets->isNotEmpty())
            @foreach($timesheets as $timesheet)
                ...
                <tr align="center">	
                    ...
                    <td>
                        <input type="checkbox" id="timesheet_approval{{ $timesheet->id }}" name="timesheet_approval[]" onchange="approveTimesheets('{{ $timesheet->id }}', '{{ $timesheet->project_id }}', '{{ $timesheet->activity_id }}', '{{ $monday }}', '{{ $sunday }}', '{{ $supervisor_user }}');"  value="{{ auth()->id() }}" @if($timesheet->approver_id > 0) checked @endif>
                    </td>
                    <td></td>
                </tr>
            @endforeach
