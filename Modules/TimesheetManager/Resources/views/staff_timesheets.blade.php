...
<!-- Main content -->
<section class="content printable_estimate_div">
    <div class="card">
          ...
          <div class="card-header">
                ...
                <div class="card-tools">
                    @if(auth()->user()->can('access', 'timesheets add') && isset($project->id))
                        <a class="btn btn-success btn-sm" href="{{ route('timesheets.staff.create', $project->id) }}">Create Timesheet</a>
                    @endif
                </div>
            </div>
        <div class="card-body">
...
<script type="text/javascript">
    ...
    function getTimesheets(project, area, level){
        var route = "{{ route('timesheets.ajax.staff') }}";
    ...
    function changeProject(projectId) {
        window.location = "{{ route('timesheets.staff') }}/" + projectId+"?change=1";
    }
