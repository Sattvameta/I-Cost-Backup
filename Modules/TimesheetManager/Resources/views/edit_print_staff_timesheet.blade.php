...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="card-title">Print Timesheet</h3><hr>
            <div class="card-tools">
                <a class="btn btn-primary btn-sm print_timesheet" href="javascript:;" title="Print" id="print_timesheet" onclick="printFunction()">Print</a>
      ...
      function printFunction() { 
        ...
        <div class="card-body page">
            ...
            <img src='../../../../../storage/app/public/{{ $timesheet->project->company->company_logo}}' alt="" height="50px" width="50px"><span style="
    font-size: 18px;
    font-weight: 600;margin-left: 12px;
">{{ $timesheet->project->company->company_name }}</span><br><br>
            @elseif(auth()->user()->isRole('Admin'))
                <img src='../../../../../storage/app/public/{{ auth()->user()->company_logo}}' alt="" height="50px" width="50px"><span style="
    font-size: 18px;
    font-weight: 600;margin-left: 12px;
">{{ auth()->user()->company_name}}</span><br><br>
@else
<img src='../../../../../storage/app/public/{{ auth()->user()->company->company_logo}}' alt="" height="50px" width="50px"><span style="
    font-size: 18px;
    font-weight: 600;margin-left: 12px;
">{{ auth()->user()->company->company_name}}</span><br><br>
@endif
        ...
        <tr class="table-success">
            ...
            <tr>
			 <td>Home<br>Office<br>Hybrid</td> 
			  ...
			  <td><input type="number" name="walking_text" id="walking_text" value="{{ $timesheet->walking_text}}" disabled="disabled"><br><input type="number" name="cycling_text" id="cycling_text" value="{{ $timesheet->cycling_text}}" disabled="disabled"><br><input type="number" name="public_transport_text" id="public_transport_text" value="{{ $timesheet->public_transport_text}}" disabled="disabled"><br><input type="number" name="car_transport_text" id="car_transport_text" value="{{ $timesheet->car_transport_text}}" disabled="disabled"><br><input type="number" name="hybrid_text" id="hybrid_text" value="{{ $timesheet->hybrid_text}}" disabled="disabled"></td>
            </tr>
</table>
        ...
        <tr class="table-success">
            ...
            <tr>
			 <td>Electricity<br>Gas</td> 
			  <td><input type="number" name="electricity" id="electricity" value="{{ $timesheet->electricity}}" disabled="disabled"><br><input type="number" name="gas" id="gas" value="{{ $timesheet->gas}}"disabled="disabled"></td>
            </tr>
</table>
    ...
    <thead>
        <tr class="table-success">
            ...
            <tr>
			  ...
			  <td><input type="number" name="laptop_kwh" id="laptop_kwh" value="{{$timesheet->laptop_kwh}}" disabled="disabled"><br><input type="number" name="desktop_kwh" id="desktop_kwh"value="{{$timesheet->desktop_kwh}}" disabled="disabled"><br><input type="number" name="others_kwh" id="others_kwh" value="{{$timesheet->others_kwh}}" disabled="disabled"></td>
            </tr>
</table>-->
        </div>
