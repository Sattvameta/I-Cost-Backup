...
class LibraryImportActivity implements ToCollection, WithChunkReading, WithHeadingRow
{
    use Importable;
    ...
    public function collection(Collection $collections)
    {
        ...
        $collections->each(function($row){
            if($row['activity_type'] == 'main_activity'){
                ...
                $this->mainActivity = LibraryMainActivity::create(
                    [
                ...
                if ($this->mainActivity instanceof \Modules\EstimateManager\Entities\LibraryMainActivity) {
                    ...
                    $this->subActivity = LibrarySubActivity::create(
                        [
                            'library_main_activity_id'  => $this->mainActivity->id,
                ...
                if ($this->subActivity instanceof \Modules\EstimateManager\Entities\LibrarySubActivity) {
                    ...
                    $activity = LibraryActivity::create(
                        [
                            'library_sub_activity_id' => $this->subActivity->id,
