...
class ExportActivityCollapsed implements FromView, WithEvents
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class  => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('J4:AD4')->applyFromArray([
                    'fill' => [
                        'fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID,
                        'startColor' => ['rgb' => '007bff']
                    ],
                ...
                $event->sheet->getDelegate()->getStyle('A7:AD7')->applyFromArray([
                    'fill' => [
                        'fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID,
                        'startColor' => ['rgb' => '007bff']
                    ],
    ...
    */
    public function view(): View
    {
        ...
        return view('estimatemanager::project.exportActivityCollapsed', [
            'project' => $project
        ]);
    }
